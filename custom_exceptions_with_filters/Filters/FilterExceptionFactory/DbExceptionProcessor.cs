...
{
    public class DbExceptionProcessor : IExceptionProcessor<List<CustomValidationError>>
    {
        public List<CustomValidationError> Process(CustomException exceptionContext)
        {
            ...
            List<CustomValidationError> errors = ex.Message.ParseTo<List<CustomValidationError>>();
